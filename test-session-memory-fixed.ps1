...
try {
    ...
    $validateUrl = "$baseUrl/sessions?action=validate" + "&" + "sessionId=$sessionId"
    ...
    $invalidUrl = "$baseUrl/sessions?action=validate" + "&" + "sessionId=invalid-session-12345"
    $invalidResponse = Invoke-RestMethod -Uri $invalidUrl
